          ...
          {FORMATS.map((item, id) => (
            <label key={id} className="block cursor-pointer">
              <input
                ...
                className="peer"
              />
              <div className="text-center peer-checked:bg-foreground peer-checked:text-background py-2 rounded hover:bg-muted/30 duration-300 peer-checked:hover:bg-foreground">
                <div>{item}</div>
